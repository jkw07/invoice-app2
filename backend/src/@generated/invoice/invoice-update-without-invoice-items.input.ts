...
import { CompanyUpdateOneRequiredWithoutInvoicesNestedInput } from '../company/company-update-one-required-without-invoices-nested.input';
...
@InputType()
export class InvoiceUpdateWithoutInvoiceItemsInput {
    ...
    @Field(() => CompanyUpdateOneRequiredWithoutInvoicesNestedInput, {nullable:true})
    @Type(() => CompanyUpdateOneRequiredWithoutInvoicesNestedInput)
