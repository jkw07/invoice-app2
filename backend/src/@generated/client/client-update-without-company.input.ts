...
import { InvoiceUpdateManyWithoutBuyerNestedInput } from '../invoice/invoice-update-many-without-buyer-nested.input';
import { Type } from 'class-transformer';

@InputType()
export class ClientUpdateWithoutCompanyInput {
    ...
    @Field(() => InvoiceUpdateManyWithoutBuyerNestedInput, {nullable:true})
    @Type(() => InvoiceUpdateManyWithoutBuyerNestedInput)
    invoices?: InvoiceUpdateManyWithoutBuyerNestedInput;
}
